...
test('contact page contains the approved clinic details', async () => {
  ...
  assert.match(html, /123, Dental Care Street, Anna Nagar/);
  assert.match(html, /Chennai, Tamil Nadu – 600001/);
  ...
  assert.match(constants, /address: '123, Dental Care Street, Anna Nagar, Chennai, Tamil Nadu – 600001'/);
});
