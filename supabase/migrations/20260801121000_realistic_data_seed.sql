...
-- Testimonials removed per compliance guidelines (no fake patient stories allowed)


-- Seed realistic gallery items using real photo fallback paths.
insert into public.gallery_items (
  ...
  (
    'Main Reception Area',
    'clinic-gallery.webp',
    'assets/images/stock/clinic-gallery.webp',
    'Clinic Interiors',
    'image/webp',
    192960,
  ...
  (
    ...
    'treatment-care.jpg',
    'assets/images/stock/treatment-care.jpg',
    'Clinic Interiors',
    'image/jpeg',
    2589664,
  ...
  (
    ...
    'assets/images/stock/video-testimonial.jpg',
    'Equipment',
    'image/jpeg',
    169108,
