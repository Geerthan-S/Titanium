...
const placeholder = stockMedia.blog;
const resources = [
...
function articleCard(article) {
  return `<article class="blog-card" id="${safe(article.slug)}">
    <div class="blog-card__media"><img src="${article.featuredImage}" data-media-fallback="blog" width="1600" height="1000" loading="lazy" alt="${safe(article.imageAlt || article.title)}"></div>
